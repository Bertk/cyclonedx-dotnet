...
namespace CycloneDX.Services
{
    public class SolutionFileService : ISolutionFileService
    {
        ...
        /// <param name="solutionFilePath"></param>
        /// <returns></returns>
        public async Task<HashSet<NugetPackage>> GetSolutionNugetPackages(string solutionFilePath, bool excludeDev)
        {
            ...
            {
                Console.WriteLine();
                var projectPackages = await _projectFileService.GetProjectNugetPackagesAsync(projectFilePath, excludeDev).ConfigureAwait(false);
